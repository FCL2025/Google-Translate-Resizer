...
```text
Google-Translate-Resizer-v0.1.10.zip
```
...
1. Download `Google-Translate-Resizer-v0.1.10.zip` from the latest release.
...
1. 從最新 Release 下載 `Google-Translate-Resizer-v0.1.10.zip`。
2. 解壓縮 ZIP。
